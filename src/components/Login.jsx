        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mb-3">
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 bg-white hover:bg-slate-50 text-slate-800 border-2 border-slate-300 font-black rounded-xl text-xs sm:text-sm shadow-md transition-all flex items-center justify-center gap-2.5 cursor-pointer border-b-4 border-b-slate-400 active:translate-y-0.5"
            >
              ...
              <span>{loading ? 'กำลังเชื่อมต่อ Google...' : 'เข้าสู่ระบบด้วย Google Account'}</span>
            </button>
          </div>

          {/* Divider */}
          <div className="relative my-3 flex items-center justify-center">
            <div className="border-t border-amber-300/80 w-full"></div>
            <span className="bg-[#fffdf5] px-2 text-[10px] font-black text-amber-800/70 uppercase">หรือกรอกข้อมูลด้วยตนเอง</span>
            <div className="border-t border-amber-300/80 w-full"></div>
          </div>
