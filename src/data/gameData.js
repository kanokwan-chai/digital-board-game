    ...
    missions: [
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "พบรอยนิ้วมือเวทมนตร์บนขวดน้ำยาพิษ", value: true, image: "/images/statements/p1.png" },
          { id: "Q", type: "Statement", content: "สารพิษที่พบคือยาพิษผสมน้ำยากล่อมประสาท", value: true, image: "/images/statements/p2.png" },
          { id: "R", type: "Statement", content: "คริสตัลบันทึกภาพคนร้ายชุดดำได้", value: true, image: "/images/statements/p3.png" }, 
      ...
      },
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "กริ่งแจ้งเตือนภัยดังขึ้นเฉพาะวันพระจันทร์เต็มดวง", value: false, image: "/images/statements/p4.png" },
          { id: "Q", type: "Statement", content: "คริสตัลบันทึกภาพคนร้ายชุดดำได้", value: true, image: "/images/statements/p3.png" },
          { id: "R", type: "Statement", content: "พบรอยนิ้วมือเวทมนตร์บนขวดน้ำยาพิษ", value: true, image: "/images/statements/p1.png" }, 
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" },
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" },
          { id: "NOT", type: "Operator", content: "ไม่", operator: "NOT", image: "/images/statements/op_not.png" } 
      ...
      },
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "มีละอองเวทเรืองแสง", value: false, image: "/images/statements/p5.png" },
          { id: "Q", type: "Statement", content: "สารพิษที่พบคือยาพิษผสมน้ำยากล่อมประสาท", value: true, image: "/images/statements/p2.png" }, 
          { id: "R", type: "Statement", content: "กริ่งแจ้งเตือนภัยดังขึ้นเฉพาะวันพระจันทร์เต็มดวง", value: false, image: "/images/statements/p4.png" }, 
          { id: "NOT", type: "Operator", content: "ไม่", operator: "NOT", image: "/images/statements/op_not.png" },
          { id: "NOT", type: "Operator", content: "ไม่", operator: "NOT", image: "/images/statements/op_not.png" },
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" }
    ...
    missions: [
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "ตรวจพบดีเอ็นเอของพยาน", value: true, image: "/images/statements/p6.png" },
          { id: "Q", type: "Statement", content: "นำตัวเข้าควบคุมเพื่อสอบปากคำ", value: true, image: "/images/statements/p7.png" },
          { id: "R", type: "Statement", content: "กล่องเก็บของกลางเปิดออก", value: true, image: "/images/statements/p8.png" }, 
          { id: "IF_THEN", type: "Operator", content: "ถ้า...แล้ว", operator: "IF_THEN", image: "/images/statements/op_if.png" },
          { id: "IF_THEN", type: "Operator", content: "ถ้า...แล้ว", operator: "IF_THEN", image: "/images/statements/op_if.png" },
          { id: "IFF", type: "Operator", content: "ก็ต่อเมื่อ", operator: "IFF", image: "/images/statements/op_iff.png" },
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" } 
        ],
      ...
      },
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "กล่องเก็บของกลางเปิดออก", value: true, image: "/images/statements/p8.png" },
          { id: "Q", type: "Statement", content: "หมุนกุญแจทองครบรอบ", value: true, image: "/images/statements/p9.png" },
          { id: "R", type: "Statement", content: "ตรวจพบดีเอ็นเอของพยาน", value: true, image: "/images/statements/p6.png" }, 
          { id: "IF_THEN", type: "Operator", content: "ถ้า...แล้ว", operator: "IF_THEN", image: "/images/statements/op_if.png" },
          { id: "IFF", type: "Operator", content: "ก็ต่อเมื่อ", operator: "IFF", image: "/images/statements/op_iff.png" },
          { id: "IFF", type: "Operator", content: "ก็ต่อเมื่อ", operator: "IFF", image: "/images/statements/op_iff.png" },
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" } 
    ...
    missions: [
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "เจ้าหน้าที่มีตราประจำหน่วย", value: true, image: "/images/statements/p10.png" },
          { id: "Q", type: "Statement", content: "ได้รับอนุมัติเป็นลายลักษณ์อักษร", value: true, image: "/images/statements/p11.png" },
          { id: "R", type: "Statement", content: "มีประวัติละเมิดกฎหมายเวทมนตร์", value: false, image: "/images/statements/p12.png" },
          { id: "S", type: "Statement", content: "เปิดเผยรหัสต่อสื่อภายนอก", value: true, image: "/images/statements/p13.png" }, 
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" }, 
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" }, 
          { id: "NOT", type: "Operator", content: "ไม่", operator: "NOT", image: "/images/statements/op_not.png" },
    ...
    missions: [
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "กรอกรหัสสะเดาะเวท", value: true, image: "/images/statements/p14.png" },
          { id: "Q", type: "Statement", content: "คลายโซ่สะกดหลักฐาน", value: false, image: "/images/statements/p15.png" },
          { id: "R", type: "Statement", content: "ตู้นิรภัยสั่นสะเทือนรุนแรง", value: false, image: "/images/statements/p4.png" },
          { id: "S", type: "Statement", content: "มีคนร้ายแอบเข้ามา", value: true, image: "/images/statements/p3.png" }, 
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" }, 
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" }, 
          { id: "OR", type: "Operator", content: "หรือ", operator: "OR", image: "/images/statements/op_or.png" }, 
      ...
      },
      {
        ...
        cards: [
          { id: "P", type: "Statement", content: "ใช้คัมภีร์ปิดผนึก", value: true, image: "/images/statements/p10.png" },
          { id: "Q", type: "Statement", content: "สวดอักขระอาร์เคน", value: true, image: "/images/statements/p11.png" },
          { id: "R", type: "Statement", content: "วงเวทย์ข้ามมิติพังทลาย", value: true, image: "/images/statements/p12.png" },
          { id: "S", type: "Statement", content: "คริสตัลขัดข้อง", value: false, image: "/images/statements/p5.png" }, 
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "AND", type: "Operator", content: "และ", operator: "AND", image: "/images/statements/op_and.png" },
          { id: "IF_THEN", type: "Operator", content: "ถ้า...แล้ว", operator: "IF_THEN", image: "/images/statements/op_if.png" },
          { id: "IF_THEN", type: "Operator", content: "ถ้า...แล้ว", operator: "IF_THEN", image: "/images/statements/op_if.png" },
